...
(let ((colors '((undef     "#ff00ff" "#ff00ff")
      ...
      (faces '(;; default / basic faces
               ...
               (font-lock-constant-face :foreground ,ctp-peach :inherit bold)
               ...
               (font-lock-preprocessor-face :foreground ,ctp-yellow :inherit bold)
               ...
               (font-lock-type-face :foreground ,ctp-yellow :inherit bold)
